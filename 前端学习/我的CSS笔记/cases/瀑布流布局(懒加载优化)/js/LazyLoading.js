;(function () {
    ...
    LazyLoading.prototype.lazyload = function(){
        ...
        for (let i = this.loadedNum; i < this.total; i++) {
            ...
            let itemOffsetTop = images[i].offsetTop || images[i].parentNode.offsetTop
            console.log(itemOffsetTop, this._clientHeight , this._scrollTop, itemOffsetTop < this._clientHeight + this._scrollTop);
            if (itemOffsetTop < this._clientHeight + this._scrollTop) {
                // 真实图片还未加载
